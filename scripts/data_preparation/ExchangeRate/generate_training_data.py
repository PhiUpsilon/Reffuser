...
parser.add_argument('--input_len', type=int, default=336, help='Input length (default: 336)')
parser.add_argument('--output_len', type=int, default=336, help='Output length (default: 336)')
