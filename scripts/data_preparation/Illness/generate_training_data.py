...
parser.add_argument('--input_len', type=int, default=96, help='Input length (default: 96)')
parser.add_argument('--output_len', type=int, default=48, help='Output length (default: 48)')
